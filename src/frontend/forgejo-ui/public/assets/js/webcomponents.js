...
var _a;
function toAbsoluteLocaleDate(date, lang, opts) {
  const dateSep = date.indexOf("T");
  date = dateSep === -1 ? date : date.substring(0, dateSep);
  return (/* @__PURE__ */ new Date(`${date}T00:00:00`)).toLocaleString(lang || [], opts);
}
      ...
      this.mutationObserver = new MutationObserver((mutations) => {
        for (const mutation of mutations) {
          for (const node of mutation.addedNodes) {
            if (!(0,_utils_dom_js__WEBPACK_IMPORTED_MODULE_2__.isDocumentFragmentOrElementNode)(node)) continue;
...
/******/ })()
;
//# sourceMappingURL=webcomponents.js.bd0f0d56.map